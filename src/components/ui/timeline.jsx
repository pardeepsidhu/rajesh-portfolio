...
export const Timeline = ({ data, theme }) => {
  ...
  return (
    <div
      className={`w-full ${bgColor} font-sans md:px-10 transition-all duration-300`}
      ref={containerRef}
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            {/* ✅ Left Section (Timeline Date + Dot) */}
            <div
          ...
          <motion.div
            ...
            className={`absolute inset-x-0 top-0 w-[2px] rounded-full ${
              theme === "dark"
                ...
                : "bg-gradient-to-t from-purple-400 via-blue-400 to-transparent"
            }`}
          />
        </div>
      </div>
